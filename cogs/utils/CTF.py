...
class CTF(commands.Cog):
    ...
    async def encryptout(context, convert, input):
        if len(input) > 1900:
            return await context.send(
                f"**{context.author.name}** 결과가 최대 출력 제한을 초과했습니다."
            )
    ...
    async def decode_base32(self, context, *, input: str):
        ...
        try:
            await self.encryptout(
                context, "base32 -> Text", base64.b32decode(input.encode("UTF-8"))
            )
        except Exception:
    ...
    async def decode_base64(self, context, *, input: str):
        ...
        try:
            await self.encryptout(
                context,
                "base64 -> Text",
                base64.urlsafe_b64decode(input.encode("UTF-8")),
            )
        except Exception:
    ...
    async def decode_rot13(self, context, *, input: str):
        ...
        try:
            await self.encryptout(
                context, "rot13 -> Text", codecs.decode(input, "rot_13")
            )
        except Exception:
    ...
    async def decode_hex(self, context, *, input: str):
        ...
        try:
            await self.encryptout(
                context, "hex -> Text", binascii.unhexlify(input.encode("UTF-8"))
            )
        except Exception:
    ...
    async def decode_base85(self, context, *, input: str):
        ...
        try:
            await self.encryptout(
                context, "base85 -> Text", base64.b85decode(input.encode("UTF-8"))
            )
        except Exception:
    ...
    async def decode_ascii85(self, context, *, input: str):
        ...
        try:
            await self.encryptout(
                context, "ASCII85 -> Text", base64.a85decode(input.encode("UTF-8"))
            )
        except Exception:
    ...
    async def _md5(self, context, *, arg):
        ...
        try:
            ...
            await self.encryptout(context, "text >> md5", _hex)
    ...
    async def _sha1(self, context, *, arg):
        ...
        try:
            ...
            await self.encryptout(context, "text >> sha1", sha_one)
        except Exception as Ex:
            await context.send("Error: " + str(Ex))
    ...
    async def _sha224(self, context, *, arg):
        ...
        try:
            ...
            await self.encryptout(context, "text >> sha224", sha224)
        except Exception as Ex:
            await context.send("Error: " + str(Ex))
    ...
    async def _sha256(self, context, *, arg):
        ...
        try:
            ...
            await self.encryptout(context, "text >> sha256", sha256)
        except Exception as Ex:
            await context.send("Error: " + str(Ex))
    ...
    async def _sha384(self, context, *, arg):
        ...
        try:
            ...
            await self.encryptout(context, "text >> sha384", sha384)
        except Exception as Ex:
            await context.send("Error: " + str(Ex))
    ...
    async def _sha512(self, context, *, arg):
        ...
        try:
            ...
            await self.encryptout(context, "text >> sha512", sha512)
